...
## Changer le symbole par défaut avec la fonction `plot` classique
...
```{r}
abricots <- read.table(file = 'http://math.agrocampus-ouest.fr/infoglueDeliverLive/digitalAssets/107912_abricotsSG.txt',
                       sep = ' ', header = TRUE)
```
